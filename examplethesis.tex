...
%% The project is now in a github repository - see https://github.com/gqmaguirejr/KTH-3rd-cycle-template-restructured--testing
%%
...
\thispagestyle{empty}
\engExpl{A dedication page is optional - it has no heading. If you do \textbf{not} need a dedication page, remove the percent symbol before the \textbackslash begin\{comment\} and 
...
(4) Vad behöver du som student leverera för att uppnå hög kvaliet (minimikrav) eller mycket hög kvalitet på avhandling?\\
...
\begin{table}[!ht]
  \begin{center}
    ...
    \begin{tabular}{l|S[table-format=4.2]|S[table-format=3.2]} % <-- Alignments: 1st column left, 2nd and 3rd decimal aligned
