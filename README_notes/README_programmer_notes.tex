...
\textbackslash thefield\{entrykey\}: Prints or retrieves the active \texttt{.bib} entry key (\eg maguire2026pipeline).

\textbackslash strfield\{entrykey\}: Returns the unexpanded string representation of the entry key.

\textbackslash currententrykey: An internal macro holding the literal key of the item currently being processed.
    \end{itemize}
