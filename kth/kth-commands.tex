...
\NewDocumentCommand{\authorCityCountryDate}{m}{
  \cs_set:Npn \@authorCityCountryDate {
    \tl_if_empty:NTF \@authorCity
      { Stockholm }
      {
        \@authorCity
        \tl_if_empty:NF \@authorCountry
          { ,~ \@authorCountry }
      }
    \tl_if_blank:nF {#1} { ,~ #1 }
  }
...
\ExplSyntaxOff
\authorCityCountryDate{\DTMmonthname{\month}\enspace\the\year}
...
\NewDocumentCommand{\secondAuthorCityCountryDate}{m}{
  \cs_set:Npn \@secondAuthorCityCountryDate {
    \tl_if_empty:NTF \@secondAuthorCity
      { Stockholm }
      {
        \@secondAuthorCity
        \tl_if_empty:NF \@secondAuthorCountry
          { ,~ \@secondAuthorCountry }
      }
    \tl_if_blank:nF {#1} { ,~ #1 }
  }
