...
\usepackage[acronym, style=super, toc=false, nonumberlist, nomain, nopostdot=true, notranslate, automake]{glossaries-extra}
...
\lstdefinelanguage{BibTeX}{
  keywords={@article,@book,@inproceedings,@misc,@techreport,@phdthesis,@manual},
  sensitive=false,
  comment=[l]{\%},
  morestring=[b]",
  morestring=[b]',
