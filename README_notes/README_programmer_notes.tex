...
\subsection{Using Biber annotation in BibLaTeX entries}
\label{sec:furtherBiberAnnotation}

Biber's data annotation syntax examples entries to carry additional information. For example:
\begin{lstlisting}[language=BibTeX, breaklines=true, basicstyle=\small\ttfamily]
