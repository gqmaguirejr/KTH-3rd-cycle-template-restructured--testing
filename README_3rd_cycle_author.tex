...
\begin{lstlisting}[language={bash}, breaklines=true, postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space}, caption={Generating \LaTeX~commands for a \gls{KTH} supervisor}, label=lst:supervisor, basicstyle=\footnotesize]
...
\begin{lstlisting}[language={bash}, breaklines=true, postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space}, caption={Generating \LaTeX~commands for a \gls{KTH} supervisor B}, label=lst:supervisorB, basicstyle=\footnotesize]
...
\begin{lstlisting}[language={bash}, breaklines=true, postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space}, caption={Generating \LaTeX~commands for an external supervisor}, label=lst:supervisorC, basicstyle=\footnotesize]
...
\begin{lstlisting}[basicstyle=\scriptsize,breaklines=true, postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space},]
Package hyperref Warning: Token not allowed in a PDF string (Unicode): removing `\Gamma' on input line 56.
\end{lstlisting}
